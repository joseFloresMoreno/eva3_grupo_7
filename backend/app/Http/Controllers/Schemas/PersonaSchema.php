...
class PersonaSchema
{
    ...
    #[OA\Property(property: "cursos", type: "array", nullable: true, items: new OA\Items(type: "object", properties: [new OA\Property(property: "nombre", type: "string"), new OA\Property(property: "institucion", type: "string"), new OA\Property(property: "anio", type: "integer")]))]
    public ?array $cursos;
    #[OA\Property(property: "idiomas", type: "array", nullable: true, items: new OA\Items(type: "object", properties: [new OA\Property(property: "idioma", type: "string"), new OA\Property(property: "nivel", type: "string", enum: ["basico","intermedio","avanzado","nativo"])]) )]
    public ?array $idiomas;
    // Se cambio por discrepancias entre las migraciones y los controladores y modelos
    #[OA\Property(property: "portafolio_url", type: "string", format: "url", nullable: true, example: "https://miportafolio.com")]
