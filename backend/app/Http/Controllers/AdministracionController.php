...
class AdministracionController extends Controller
{
    #[OA\Get(
        ...
        parameters: [
            new OA\Parameter(
                ...
                in: "query",
                required: false,
                schema: new OA\Schema(type: "string", enum: ["pendiente","contactado","entrevista","seleccionado","no-seleccionado","proceso-cerrado"])
            )
        ],
        responses: [
            new OA\Response(
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(ref: "#/components/schemas/ContactoSolicitadoInput")),
        responses: [
            new OA\Response(response: 201, description: "Contacto registrado", content: new OA\JsonContent(ref: "#/components/schemas/ContactoSolicitado")),
    ...
    #[OA\Patch(
        ...
        responses: [
            new OA\Response(response: 200, description: "Estado actualizado", content: new OA\JsonContent(ref: "#/components/schemas/ContactoSolicitado")),
